      ...
      <ul className="collapsible" data-collapsible="accordion" style={{ display: this.state.eventDisplay }}>
        ...
        <div className="modal" style={{ display: this.state.modalDisplay }}>
           ...
           <div className="modal-footer">
             <a onClick={ this.closeModal} className="modal-action modal-close waves-effect waves-light btn-flat">F&$K, Nooo!!!</a>
             <a onClick={ this.delete } className="modal-action modal-close waves-effect waves-light btn-flat">Yes, I beg you!</a>
           </div>
         </div>
